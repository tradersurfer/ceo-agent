...
class Organization {
  ...
  static createDefault() {
    ...
    const agents = [
      ...
      { id: 'sales_intake_agent', name: 'Sales Intake Agent', title: 'VP of Sales', department: 'marketing', role: 'vp_sales', capabilities: ['sales_strategy', 'create_lead', 'intake_capture'], models: ['GPT'], reportsTo: 'cmo_agent', offLimits: [
      ...
      { id: 'onboarding_comms_agent', name: 'Onboarding Communications Agent', title: 'Client Onboarding Email Lifecycle Agent', department: 'marketing', role: 'onboarding_comms_lead', capabilities: ['email_welcome', 'email_score_invite', 'email_upload_reminder', 'email_review_call', 'email_scan_complete', 'email_mail_reminder', 'email_bureau_checkin', 'email_sweep_upgrade', 'email_testimonial', 'email_sequence_queue'], models: ['GPT'], reportsTo: 'cmo_agent', offLimits: [
        { id: 'unsolicited_email', label: 'Sending unsolicited emails', restricts: ['email_welcome', 'email_score_invite', 'email_upload_reminder', 'email_review_call', 'email_scan_complete', 'email_mail_reminder', 'email_bureau_checkin', 'email_sweep_upgrade', 'email_testimonial', 'email_sequence_queue'], enforceable: false },
