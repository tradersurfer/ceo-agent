...
class Organization {
  ...
  static createDefault() {
    ...
    const agents = [
      ...
      { id: 'cfo_agent', name: 'CFO Agent', title: 'Chief Financial Officer', department: 'finance', role: 'chief_financial_officer', skills: ['priority_scoring', 'decision_memo', 'status_synthesis', 'escalation_assessment', 'quality_review', 'budget_token_allocation'], capabilities: ['financial_strategy', 'financial_forecasting'], models: ['GPT', 'Claude'], reportsTo: 'ceo_agent' },
      { id: 'cto_agent', name: 'CTO Agent', title: 'Chief Technology Officer', department: 'technology', role: 'chief_technology_officer', skills: ['task_decomposition', 'delegation_brief', 'priority_scoring', 'decision_memo', 'status_synthesis', 'escalation_assessment', 'workload_balancing', 'quality_review', 'budget_token_allocation'], capabilities: ['technology_strategy', 'software_development'], models: ['Codex', 'GPT'], reportsTo: 'ceo_agent' },
      { id: 'cmo_agent', name: 'CMO Agent', title: 'Chief Marketing Officer', department: 'marketing', role: 'chief_marketing_officer', skills: ['task_decomposition', 'delegation_brief', 'priority_scoring', 'decision_memo', 'status_synthesis', 'escalation_assessment', 'workload_balancing', 'quality_review', 'budget_token_allocation'], capabilities: ['marketing_strategy', 'content_creation'], models: ['Claude', 'GPT'], reportsTo: 'ceo_agent' },
