...
class Organization {
  ...
  static createDefault() {
    ...
    const agents = [
      { id: 'ceo_agent', name: 'CEO Agent', title: 'Chief Intelligence & Orchestration Agent', department: 'executive', role: 'chief_intelligence_officer', skills: ['task_decomposition', 'delegation_brief', 'priority_scoring', 'decision_memo', 'status_synthesis', 'escalation_assessment', 'department_capability_lookup', 'workload_balancing', 'quality_review', 'budget_token_allocation', 'web_search'], capabilities: ['task_routing', 'agent_supervision', 'project_memory', 'business_strategy', 'research_synthesis', 'quality_control', 'brand_enforcement', 'revenue_prioritization', 'escalation_management', 'agent_registry_management'], models: ['GPT', 'Claude'], reportsTo: null },
