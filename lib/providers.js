...
// (sdk/OpenAIClient.js); 'google' joined in Phase 2's third PR
// (sdk/GoogleClient.js); 'xai' joined in Phase 2's fourth and last PR
// (sdk/XaiClient.js) — every provider id this table lists now has a real
// ProviderClient; there is no remaining "connected, not yet active" gap
// left by this list.
//
...
// provider's label".
const ACTIVE_PROVIDER_IDS = Object.freeze(['openrouter', 'anthropic', 'openai', 'google', 'xai']);
