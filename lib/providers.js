...
// PR (sdk/AnthropicClient.js) — everything else is still "connected, not
// yet active" once a key is stored, pending their own ProviderClient PRs.
//
...
// provider's label".
const ACTIVE_PROVIDER_IDS = Object.freeze(['openrouter', 'anthropic']);
