...
// (sdk/GoogleClient.js) — everything else ('xai') is still "connected, not
// yet active" once a key is stored, pending its own ProviderClient PR.
//
...
// provider's label".
const ACTIVE_PROVIDER_IDS = Object.freeze(['openrouter', 'anthropic', 'openai', 'google']);
